  ...
  return (
    <div className={styles.chatInputBar}>
      <div className={styles.chatInputWrapper}>
        ...
        <button className={styles.iconButton} onClick={handlePlusClick} title="Attach a file">
          +
        </button>
        <div className={styles.inputWrapper}>
          {selectedFile && (
            <div className={styles.filePreview}>
              ...
              <button className={styles.fileRemove} onClick={removeSelectedFile}>
                ×
              </button>
            </div>
          )}
        ...
        {isGenerating ? (
          <button className={`${styles.iconButton} ${styles.stop}`} onClick={handleStop} title="Stop generating">
